...
#define FACTOR_CHARGE_QLSB		(float)0.340E-3			// 0.340mAh when, Prescalar = 4096 and Rsns = 50mOhms
...
typedef struct
{
	...
	float 				vth_max;			// Max value of voltage threshold
	float  				cth_max;			// Max value of current threshold
